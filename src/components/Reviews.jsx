            ...
            <div className='row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 container-lg mx-auto'>
                <div className="col" >
                    <div className="card text-center">
                        <img src="/public/images/customer1.jpg" className="card-img-top" alt="..." />
                ...
                <div className="col" >
                    <div className="card text-center">
                        <img src="/public/images/customer2.jpg" className="card-img-top" alt="..." />
                        <div className="card-body">
                ...
                <div className="col" >
                    <div className="card text-center">
                        <img src="/public/images/customer3.jpg" className="card-img-top" alt="..." />
                        <div className="card-body">
